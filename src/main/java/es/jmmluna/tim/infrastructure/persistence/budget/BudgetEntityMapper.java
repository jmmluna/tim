...
public class BudgetEntityMapper {
	...
	public Budget toModel(BudgetEntity entity) {
		...
		return new Budget(BudgetId.of(entity.getUuid()), CustomerId.of(entity.getCustomer().getUuid()),
				entity.getBudgetNumber(), entity.getDescription(), entity.getYear(), entity.getDate(),
				toBudgetItemList(entity.getBudgetItems()), entity.getExpirationDate());
...
//		log.info("*********************************************Precio de la Entidad---->" + entity.getPrice());
		return new BudgetItem(BudgetItemId.of(entity.getUuid()), entity.getDescription(), entity.getAmount(),
